...
public class EnchereManagerImpl implements EnchereManager
{
	...
	public List<Categorie> getCategories() throws BllException 
	{
		...
		{
			throw new BllException("Pb sur la lecture des catï¿½gories " + e.getMessage());
		}
	...
	/**
	 * Mise Ã  jour de l'Ã©ata de l'enchere
	...
	public void updateEnchereEtatVente(ArticleVendu article) throws BllException
	{
		...
		{
			throw new BllException("Pb sur la mise Ã  jour de l'Ã©tat de vente " + e.getMessage());
		}
	}
}
