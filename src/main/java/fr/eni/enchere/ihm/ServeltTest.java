...
public class ServeltTest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		/************* l'utilisateur fait une ench�re *************/
		try
		{
			user = userMng.getUtilisateur("Foufou","123456");
			
			System.out.println("---------------------------------------");
			System.out.println("-  " + user.getNom() +" ralise une ench�re");
			System.out.println("---------------------------------------");
		...
		{
			System.out.println("erreur sur la cr�ation de l'ench�re (" + user.getNom() + ")" + e.getMessage());
		}
		try
		{
			user = userMng.getUtilisateur("Foufou","123456");
		...
		try
		{
			...
			System.out.println("---------------------------------------");
			System.out.println("-  " + user2.getNom() +" r�alise une ench�re");
			System.out.println("---------------------------------------");
		...
		{
			System.out.println("erreur sur la cr�ation de l'ench�re (" + user2.getNom() + ")" + e.getMessage());
		}
		...
		try
		{
			...
			System.out.println("---------------------------------------");
			System.out.println("-  " + user3.getNom() +" r�alise une ench�re");
			System.out.println("---------------------------------------");
		...
		{
			System.out.println("erreur sur la cr�ation de l'ench�re (" + user3.getNom() + ")" + e.getMessage());
		}
		try
		{
			user3 = userMng.getUtilisateur("Oups","123456");
		...
		{
			System.out.println("---------------------------------------");
			System.out.println("-   Liste des ench�res de "+ user.getNom());
			System.out.println("---------------------------------------");
