...
class UtilisateurDAOImplTest 
{
	...
	/**
	 * V�rification de la cr�ation d'un utilisateur en base
	 */
	@Test 
	@Order(2)
	void testCreateUser() 
	...
	/**
	 * V�rification de la lecture d'un uilisateur en base
	 */
	@Test 
	@Order(3)
	...
	void testDeleteUser() 
	{
		...
		/* vérifier que l'utilisateur est bien supprimer de la base */
		/* lecture des info en base */
		try 
		{
			utilisateur = utilisateurDAO.getUserConnection(utilisateur.getPseudo(), utilisateur.getMotDePasse());
